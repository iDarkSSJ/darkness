...
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
          ...
          function(module3, exports3, __webpack_require__) {
            (function(Buffer2, global2, module4, process2) {
              ...
              var SynchronousFileSystem = function(BaseFileSystem2) {
                ...
                if (BaseFileSystem2) SynchronousFileSystem2.__proto__ = BaseFileSystem2;
              ...
              var UnlockedOverlayFS = function(BaseFileSystem$$1) {
                ...
                if (BaseFileSystem$$1) UnlockedOverlayFS2.__proto__ = BaseFileSystem$$1;
  ...
  function createEmscriptenFS({ ERRNO_CODES, FS, PATH }) {
  ...
  function patchCoreJs({ js: js2, name: name2 }) {
    let jsContent2 = js2;
  ...
  class Emulator {
    ...
    writeConfigFile({ config, path: path2 }) {
      ...
      let fileContent = ini$1.stringify(config, { platform: "linux", whitespace: true });
  ...
  const _Nostalgist = class _Nostalgist {
    ...
    async getCoreOption() {
      ...
      if (typeof core === "string") {
        ...
        coreDict = { js: js22, name: core, wasm: wasm2 };
      } else {
        coreDict = core;
      }
      let { js: js2, name: name2, wasm } = coreDict;
      const promises = [];
