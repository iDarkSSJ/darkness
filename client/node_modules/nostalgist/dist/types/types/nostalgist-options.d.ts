...
export type NostalgistOptionsFile = {
    fileContent: Blob;
    fileName: string;
} | Blob | string;
...
export type NostalgistResolveFileFunction = (file: string, options: NostalgistOptions) => MaybePromise<NostalgistOptionsFiles | undefined>;
export interface NostalgistOptions {
    ...
    resolveShader: (shader: NostalgistOptions['shader'], options: NostalgistOptions) => MaybePromise<NostalgistOptionsFiles | undefined>;
